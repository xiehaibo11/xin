<template>
    <div>
        ...
        <div class="dlt-wrapper">
            ...
            <!--滚动期号信息 end-->
            <!--标准选号-->
            <dlt-base-bet v-show="type==1" :type="type" :text="selected" :miss="miss" :expect="initData.expect" :end-time="initData.end_time" title="大乐透" name="dlt"></dlt-base-bet>
            <!--单式投注-->
            <dlt-copy-bet v-show="type==2" :type="type" :text="selected" :expect="initData.expect" :end-time="initData.end_time" title="大乐透" name="dlt"></dlt-copy-bet>
            <!--胆拖选号-->
            <dlt-dt-bet v-show="type==3" :type="type" :text="selected" :miss="miss" :expect="initData.expect" :end-time="initData.end_time" title="大乐透" name="dlt"></dlt-dt-bet>
            <!--定胆杀号-->
            <dlt-dd-sh-bet v-show="type==4" :type="type" :text="selected" :miss="miss" :expect="initData.expect" :end-time="initData.end_time" title="大乐透" name="dlt"></dlt-dd-sh-bet>
        </div>
    </div>
</template>

<script>
    import DltBaseBet from 'components/competition/shuzicai/dlt/DltBaseBet.vue' //大乐透标准投注
    import DltCopyBet from 'components/competition/shuzicai/dlt/DltCopyBet.vue' //大乐透单式投注
    import DltDtBet from 'components/competition/shuzicai/dlt/DltDtBet.vue' //大乐透胆拖投注
    import DltDdShBet from 'components/competition/shuzicai/dlt/DltDdShBet.vue' //大乐透定胆杀号
    export default {
        name: 'dlt',
        components:{
            DltBaseBet,
        ...
        data () {
            return {
                ...
                recentOpenCodeArr:[
                    {expect:'19022',foreCode:['06','13','16','19','29'],backCode:['03','07']},
                    {expect:'19023',foreCode:['06','13','16','19','29'],backCode:['03','07']},
                    {expect:'19024',foreCode:['06','13','16','19','29'],backCode:['03','07']},
                    {expect:'19025',foreCode:['06','13','16','19','29'],backCode:['03','07']},
                    {expect:'19026',foreCode:['06','13','16','19','29'],backCode:['03','07']},
                    ]
            }
        },
        computed:{
        ...
        created(){
            let data = {
                ...
                miss:{
                    "fore" : [ 1, 6, 3, 2, 4, 20, 0, 1, 9, 6, 2, 7, 0, 7, 8, 1, 0, 3, 2, 7, 16, 4, 20, 0, 2, 3, 1, 5, 14, 6, 7, 2, 0, 1, 28 ],
                    "back" : [ 0, 2, 1, 4, 14, 3, 9, 8, 7, 0, 7, 1 ]
                }
            }
            ...
            this.timeInterval();
            this.$store.commit('setKeepAlivePage','dlt')
        },
        //离开当前投注页面
        beforeRouteLeave(to, from, next){
            if(to.path =='/shuzicai/bet'){
                ...
                this.$store.commit('delKeepAlivePage','dlt') //清除投注页面缓存
