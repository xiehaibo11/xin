...
<template>
    <div>
        ...
        <div class="step1" v-if="steps == 1">
            <div class="input-title">设置新密码</div>
            <div>
                <mt-field label="新密码" placeholder="请输入新密码(长度6-25)"  v-model="password1" type="password"></mt-field>
                <mt-field label="重复密码" placeholder="请再次输入新密码(长度6-25)"  v-model="password2" type="password"></mt-field>
            </div>
            <div class="btn-box">
        ...
        <div class="step2" v-if="steps == 2">
            ...
            <div class="chose detail">
                <mt-cell title="验证原密码" label="能记住原密码可选此方式" is-link @click.native="choseWay(1)">
        ...
        <div class="step3" v-if="steps == 3">
            ...
            <div v-if="checkWay == 1">
                ...
                <div>
                    <mt-field label="原密码" placeholder="请输入原密码" type="password" v-model="oldPwd"></mt-field>
                </div>
            </div>
            <!--验证手机号-->
            <div v-if="checkWay == 2">
                <div class="input-title">安全验证</div>
                <safe-check url="/index/user/sendSmsPassword" v-model="telYzm" :check-way="1"></safe-check>
            </div>
            <!--验证邮箱-->
            <div v-if="checkWay == 3">
                <div class="input-title">安全验证</div>
                <safe-check url="/web/user/sendPwdEmail" v-model="emailYzm" :check-way="2"></safe-check>
            </div>
        ...
        methods:{
            ...
            sumbit(){
                ...
                if(this.checkWay == 1){
                    ...
                    postUrl = '/web/user/checkPwdEmail'
                    data ={
                        yzm: this.emailYzm,
                        password: this.password1,
                        password2: this.password2,
