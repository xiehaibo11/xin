                ...
                <ul class="balls-box">
                    <li v-for="(item,index) in ball" :key="index">
                        ...
                        <template v-if="miss !== 0">
                            <i class="f-mini c-3" v-if="wz==1" :class="{'red':miss.qw[index]>10}">{{miss.qw[index]}}</i>
                            <i class="f-mini c-3" v-if="wz==2" :class="{'red':miss.qsi[index]>10}">{{miss.qsi[index]}}</i>
                            <i class="f-mini c-3" v-if="wz==3" :class="{'red':miss.qs[index]>10}">{{miss.qs[index]}}</i>
                            <i class="f-mini c-3" v-if="wz==4" :class="{'red':miss.qe[index]>10}">{{miss.qe[index]}}</i>
                            <i class="f-mini c-3" v-if="wz==5" :class="{'red':miss.qy[index]>10}">{{miss.qy[index]}}</i>
                        </template>
                        <template v-else>
