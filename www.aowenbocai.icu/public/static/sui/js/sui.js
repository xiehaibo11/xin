 ...
 *  - pageInitInternal: （经 bootstrap-switch-init.js 处理后，对外是 pageInit）紧跟着动画完成的事件，实参是 event，sectionId 和 $section
 *
 * 术语
...
+function($) {
    ...
    Router.prototype._animateDocument = function($from, $to, $visibleSection, direction) {
        ...
        $to.animationEnd(function() {
            ...
            // 外层（bootstrap-switch-init.js）中会绑定 pageInitInternal 事件，然后对页面进行初始化
