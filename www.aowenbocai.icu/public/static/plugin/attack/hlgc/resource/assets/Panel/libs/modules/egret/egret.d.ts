...
declare namespace egret {
    /**
     * Bitmap fonts, texture set of a fonts. It is generally used as the value of the BitmapText.fonts attribute.
     * @see http://bbs.egret-labs.org/thread-918-1-1.html TextureMerger
     * @see http://bbs.egret-labs.org/forum.php?mod=viewthread&tid=251 Text(Containing the specific usage of the bitmap fonts )
     * @version Egret 2.4
     * @platform Web,Native
...
declare namespace egret {
    /**
     * Bitmap fonts adopts the Bitmap+SpriteSheet mode to render text.
     * @version Egret 2.4
     * @platform Web,Native
    ...
    class BitmapText extends DisplayObject {
        ...
        /**
         * The name of the fonts to use, or a comma-separated list of fonts names, the type of value must be BitmapFont.
         * @default null
         * @version Egret 2.4
         * @platform Web,Native
         * @language en_US
...
declare namespace egret {
    /**
     * TextField is the text rendering class of egret. It conducts rendering by using the browser / device API. Due to different ways of fonts rendering in different browsers / devices, there may be differences in the rendering
    ...
    class TextField extends DisplayObject {
        ...
        $setTouchEnabled(value: boolean): void;
        /**
         * The name of the fonts to use, or a comma-separated list of fonts names.
         * @default "Arial"
         * @version Egret 2.4
         * @platform Web,Native
         * @language en_US
        ...
        /**
         * Determines whether the text is italic fonts.
         * @default false
         * @version Egret 2.4
         * @platform Web,Native
         * @language en_US
