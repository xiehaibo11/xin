...
generateEUI.paths['resource/eui_skins/ButtonSkin.exml'] = window.skins.ButtonSkin = (function (_super) {
	...
	function GameUiSkin() {
		_super.call(this);
		this.skinParts = ["pay","cityImg","recharge","active","award","set","head","btns","back","bottom","Panel","history","fight","soldiers","reading","help","payBack2","payPanel","payBack","payGroup","auto_fight","createRoom","JionRoom"];
		
		this.height = 1136;
		this.width = 640;
		this.pay_i();
		this.elementsContent = [this._Image1_i(),this._Group1_i(),this.head_i(),this.bottom_i(),this.history_i(),this.fight_i(),this.soldiers_i(),this.reading_i(),this.help_i(),this.payGroup_i(),this._Group5_i()];
	...
	function AutoGameSkin() {
		_super.call(this);
		this.skinParts = ["back1","sc","back","joinRoom","room","input0","question0","join","room0","createSure","createCancel","input1","question1","input2","question2","auto_selected","question3","auto_go"];
		...
		this.states = [
			new eui.State ("auto",
				[
					...
					new eui.AddItems("question1","_Group4",1,""),
					new eui.AddItems("_Group4","_Group7",1,""),
					new eui.AddItems("question2","_Group5",1,""),
					new eui.AddItems("_Group5","_Group7",1,""),
					new eui.AddItems("question3","_Group6",1,""),
					new eui.AddItems("_Group6","_Group7",1,""),
					new eui.AddItems("auto_go","_Group7",1,"")
				])
			,
			new eui.State ("createRoom",
				[
					new eui.AddItems("room","_Group1",1,""),
					new eui.AddItems("room0","_Group2",1,""),
					new eui.AddItems("_Group2","_Group7",1,""),
					new eui.AddItems("_Group3","_Group7",1,""),
			...
			new eui.State ("joinRoom",
				[
					...
					new eui.AddItems("join","_Group7",1,""),
	...
	_proto._Group8_i = function () {
		...
		t.right = 0;
		t.top = 0;
		t.elementsContent = [this.back1_i(),this.sc_i(),this._Image1_i(),this._Label1_i(),this.back_i(),this._Group7_i()];
		return t;
	};
	...
	_proto._Group4_i = function () {
		...
		t.y = 305;
		t.layout = this._HorizontalLayout4_i();
		t.elementsContent = [this._Label4_i(),this.input1_i()];
		return t;
	};
	_proto._HorizontalLayout4_i = function () {
		var t = new eui.HorizontalLayout();
	...
	_proto._Group5_i = function () {
		...
		t.elementsContent = [this._Label5_i(),this.input2_i()];
		return t;
	};
	...
	_proto._Group6_i = function () {
		...
		t.elementsContent = [this._Label6_i(),this.auto_selected_i()];
		return t;
	};
