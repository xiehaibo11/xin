...
generateEUI.paths['resource/eui_skins/ButtonSkin.exml'] = window.skins.ButtonSkin = (function (_super) {
	...
	function GameUiSkin() {
		_super.call(this);
		this.skinParts = ["pay","cityImg","recharge","active","award","set","head","btns","back","bottom","Panel","history","fight","soldiers","reading","help","payBack2","payPanel","payBack","payGroup"];
		
		this.height = 1136;
		this.width = 640;
		this.pay_i();
		this.elementsContent = [this._Image1_i(),this._Group1_i(),this.head_i(),this.bottom_i(),this.history_i(),this.fight_i(),this.soldiers_i(),this.reading_i(),this.help_i(),this.payGroup_i()];
