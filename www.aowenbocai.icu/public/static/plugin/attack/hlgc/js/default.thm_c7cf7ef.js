...
generateEUI.paths['resource/eui_skins/ButtonSkin.exml'] = window.skins.ButtonSkin = (function (_super) {
	...
	function HistoryPanelSkin() {
		_super.call(this);
		this.skinParts = ["back","sc","back1","scrollerList","scroller","zero"];
		...
		this.states = [
			new eui.State ("history",
				[
					...
					new eui.SetProperty("scroller","height",530),
					...
					new eui.SetProperty("_Group2","top",200),
					new eui.SetProperty("_Group2","height",773.09)
				])
			,
			new eui.State ("help",
				[
