...
generateEUI.paths['resource/eui_skins/ButtonSkin.exml'] = window.skins.ButtonSkin = (function (_super) {
	...
	function GameUiSkin() {
		_super.call(this);
		this.skinParts = ["pay","cityImg","recharge","active","award","set","head","btns","back","bottom","Panel","history","fight","soldiers","reading","help","payBack2","payPanel","payBack","payGroup","auto_fight","createRoom","JionRoom","alertSure","alertCancel","alert"];
		
		this.height = 1136;
		this.width = 640;
		this.pay_i();
		this.elementsContent = [this._Image1_i(),this._Group1_i(),this.head_i(),this.bottom_i(),this.history_i(),this.fight_i(),this.soldiers_i(),this.reading_i(),this.help_i(),this.payGroup_i(),this._Group5_i(),this._Group6_i()];
	...
	_proto.alert_i = function () {
		...
		t.verticalCenter = 0;
		t.width = 400;
		t.elementsContent = [this._Image10_i(),this._Label5_i(),this._Label6_i(),this.alertSure_i(),this.alertCancel_i()];
		return t;
	};
	...
	var AlertSkin$Skin10 = 	(function (_super) {
		__extends(AlertSkin$Skin10, _super);
		function AlertSkin$Skin10() {
			_super.call(this);
			this.skinParts = ["labelDisplay"];
		...
		var _proto = AlertSkin$Skin10.prototype;
	...
	var AutoGameSkin$Skin13 = 	(function (_super) {
		__extends(AutoGameSkin$Skin13, _super);
		function AutoGameSkin$Skin13() {
			_super.call(this);
			this.skinParts = ["labelDisplay"];
		...
		var _proto = AutoGameSkin$Skin13.prototype;
		...
		return AutoGameSkin$Skin13;
	})(eui.Skin);

	var AutoGameSkin$Skin14 = 	(function (_super) {
		__extends(AutoGameSkin$Skin14, _super);
		function AutoGameSkin$Skin14() {
			_super.call(this);
			this.skinParts = ["labelDisplay"];
		...
		var _proto = AutoGameSkin$Skin14.prototype;
		...
		this.states = [
			...
			new eui.State ("createRoom",
				[
					...
					new eui.SetProperty("_Label2","text","房间密码："),
			...
			new eui.State ("joinRoom",
				[
					...
					new eui.SetProperty("_Label2","text","输入密码："),
					new eui.SetProperty("_VerticalLayout2","gap",6)
				])
		];
	}
	...
	_proto.createCancel_i = function () {
		...
		t.x = 228;
		t.y = 33;
		t.skinName = AutoGameSkin$Skin13;
		return t;
	};
	_proto._Group3_i = function () {
		var t = new eui.Group();
	...
	_proto.auto_go_i = function () {
		...
		t.x = 245;
		t.y = 540;
		t.skinName = AutoGameSkin$Skin14;
		return t;
	};
	_proto._VerticalLayout1_i = function () {
		var t = new eui.VerticalLayout();
