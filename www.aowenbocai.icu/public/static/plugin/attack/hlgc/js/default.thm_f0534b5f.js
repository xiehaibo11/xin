...
generateEUI.paths['resource/eui_skins/ButtonSkin.exml'] = window.skins.ButtonSkin = (function (_super) {
	...
	function GameUiSkin() {
		_super.call(this);
		this.skinParts = ["cityImg","recharge","active","award","set","head","cut","add","codeInpt","back","all_in","bottom","Panel","history","fight","soldiers","reading","help","auto_fight","createRoom","JionRoom","alertSure","alertCancel","alert","coupon"];
		
		this.height = 1136;
		this.width = 640;
		this.elementsContent = [this._Image1_i(),this._Group1_i(),this.head_i(),this.bottom_i(),this.history_i(),this.fight_i(),this.soldiers_i(),this.reading_i(),this.help_i(),this._Group6_i(),this._Group7_i(),this._Group8_i()];
	}
	...
	_proto._Group8_i = function () {
		...
		t.visible = false;
		t.width = 320;
		t.elementsContent = [this._Rect10_i(),this.coupon_i()];
		return t;
	};
	...
	function AutoGameSkin() {
		_super.call(this);
		this.skinParts = ["back1","sc","back","room","joinRoom","plunder","join","createSure","createCancel","Beplunder","Single","auto_selected","autoSoldier","auto_go"];
		...
		this.states = [
			new eui.State ("auto",
				[
					new eui.AddItems("_TextInput1","plunder",1,""),
					new eui.AddItems("_Image3","plunder",1,""),
					new eui.AddItems("_Image4","Beplunder",1,""),
					new eui.AddItems("Beplunder","_Group2",1,""),
					new eui.AddItems("_Image5","Single",1,""),
					new eui.AddItems("Single","_Group2",1,""),
					new eui.AddItems("_Image6","autoSoldier",1,""),
					new eui.AddItems("autoSoldier","_Group2",1,""),
					new eui.AddItems("auto_go","_Group2",1,""),
					new eui.SetProperty("_VerticalLayout2","gap",6)
				])
			,
			new eui.State ("createRoom",
				[
					new eui.AddItems("room","plunder",1,""),
					new eui.AddItems("_Group1","_Group2",1,""),
					...
					new eui.SetProperty("plunder","layout",this._VerticalLayout1),
			...
			new eui.State ("joinRoom",
				[
					new eui.AddItems("joinRoom","plunder",1,""),
					new eui.AddItems("join","_Group2",1,""),
	...
	_proto._Group3_i = function () {
		...
		t.right = 0;
		t.top = 0;
		t.elementsContent = [this.back1_i(),this.sc_i(),this._Image1_i(),this._Label1_i(),this.back_i(),this._Group2_i()];
		return t;
	};
	...
	_proto._Group2_i = function () {
		...
		t.elementsContent = [this.plunder_i()];
		return t;
	};
	...
	_proto.Beplunder_i = function () {
		...
		t.y = 305;
		t.layout = this._HorizontalLayout3_i();
		t.elementsContent = [this._Label3_i(),this._TextInput2_i()];
		return t;
	};
	_proto._HorizontalLayout3_i = function () {
		var t = new eui.HorizontalLayout();
	...
	_proto.Single_i = function () {
		...
		t.elementsContent = [this._Label4_i(),this._TextInput3_i()];
		return t;
	};
	...
	var AutoPanelSkin$Skin14 = 	(function (_super) {
		__extends(AutoPanelSkin$Skin14, _super);
		function AutoPanelSkin$Skin14() {
			_super.call(this);
			this.skinParts = ["labelDisplay"];
		...
		var _proto = AutoPanelSkin$Skin14.prototype;
		...
		return AutoPanelSkin$Skin14;
	})(eui.Skin);

	var AutoPanelSkin$Skin15 = 	(function (_super) {
		__extends(AutoPanelSkin$Skin15, _super);
		function AutoPanelSkin$Skin15() {
			_super.call(this);
			this.skinParts = ["labelDisplay"];
		...
		var _proto = AutoPanelSkin$Skin15.prototype;
		...
		return AutoPanelSkin$Skin15;
	})(eui.Skin);

	function AutoPanelSkin() {
		_super.call(this);
		this.skinParts = ["sc","winMoney","loseMoney","NowWinMoney","NowLoseMoney","outSure","outCancel","alert","cancel"];
		
		this.height = 1136;
		this.width = 640;
		this.elementsContent = [this._Rect1_i(),this.sc_i(),this._Image1_i(),this._Label1_i(),this._Group5_i(),this._Group6_i(),this.cancel_i()];
	}
	...
	_proto._Group6_i = function () {
		...
		t.top = 0;
		t.visible = false;
		t.elementsContent = [this._Rect6_i(),this.alert_i()];
		return t;
	};
	_proto._Rect6_i = function () {
		var t = new eui.Rect();
	...
	_proto.alert_i = function () {
		...
		t.verticalCenter = 0;
		t.width = 400;
		t.elementsContent = [this._Image2_i(),this._Label6_i(),this._Label7_i(),this.outSure_i(),this.outCancel_i()];
		return t;
	};
	_proto._Image2_i = function () {
		var t = new eui.Image();
	...
	_proto.outCancel_i = function () {
		...
		t.right = 50;
		t.width = 120;
		t.skinName = AutoPanelSkin$Skin14;
		return t;
	};
	_proto.cancel_i = function () {
		...
		t.top = 120;
		t.width = 80;
		t.skinName = AutoPanelSkin$Skin15;
		return t;
	};
	...
	function ShowResultSkin() {
		_super.call(this);
		this.skinParts = ["giftImg","gift","group"];
		...
		this.states = [
			...
			new eui.State ("zero",
				[
					...
					new eui.SetProperty("_Rect1","bottom",0),
					new eui.SetProperty("_Image1","visible",false),
					new eui.SetProperty("_Image2","x",61),
					new eui.SetProperty("_Image2","y",15),
					new eui.SetProperty("_Image3","x",38),
					new eui.SetProperty("_Image3","y",71),
					new eui.SetProperty("_Image4","y",104),
					new eui.SetProperty("_Image4","x",140),
					new eui.SetProperty("giftImg","source","sprite-bubble-title_json.sprite-bubble-title006"),
					new eui.SetProperty("giftImg","y",160),
					new eui.SetProperty("giftImg","x",35),
					new eui.SetProperty("_Label1","visible",false),
					new eui.SetProperty("gift","visible",false),
					new eui.SetProperty("group","width",433),
					new eui.SetProperty("group","y",397),
					new eui.SetProperty("group","x",104)
				])
		];
	}
