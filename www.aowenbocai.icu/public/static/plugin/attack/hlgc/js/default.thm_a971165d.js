...
generateEUI.paths['resource/eui_skins/ButtonSkin.exml'] = window.skins.ButtonSkin = (function (_super) {
	...
	function GameUiSkin() {
		_super.call(this);
		this.skinParts = ["read","cityImg","recharge","active","award","set","head","btns","back","bottom","Panel","history","fight","soldiers","reading","help"];
		
		this.height = 1136;
		this.width = 640;
		this.read_i();
		this.elementsContent = [this._Image1_i(),this._Group1_i(),this.head_i(),this.bottom_i(),this.history_i(),this.fight_i(),this.soldiers_i(),this.reading_i(),this.help_i()];
		
		eui.Binding.$bindProperties(this, ["reading"],[0],this._TweenItem1,"target")
		eui.Binding.$bindProperties(this, [500],[],this._Object1,"x")
		eui.Binding.$bindProperties(this, [232],[],this._Object2,"x")
	}
	var _proto = GameUiSkin.prototype;

	_proto.read_i = function () {
		var t = new egret.tween.TweenGroup();
		this.read = t;
		t.items = [this._TweenItem1_i()];
		return t;
	...
	function BetHistorySkin() {
		_super.call(this);
		this.skinParts = ["back","sc","back1","scrollerList","loading","more","scroller"];
	...
	_proto._Group2_i = function () {
		...
		t.verticalCenter = -20;
		t.width = 640;
		t.elementsContent = [this.sc_i(),this._Image1_i(),this.back1_i(),this._Rect6_i(),this.scroller_i(),this._Label1_i()];
		return t;
	};
	...
	function HistoryPanelSkin() {
		_super.call(this);
		this.skinParts = ["back","sc","back1","scrollerList","scroller"];
		...
		this.states = [
			new eui.State ("history",
				[
					...
					new eui.SetProperty("sc","top",100),
					new eui.SetProperty("sc","height",562),
					new eui.SetProperty("scroller","anchorOffsetY",0),
					new eui.SetProperty("scroller","horizontalCenter",0),
					new eui.SetProperty("scroller","top",220),
					new eui.SetProperty("scroller","height",430),
					new eui.SetProperty("_Label4","right",90),
					new eui.SetProperty("_Group2","verticalCenter",32),
					new eui.SetProperty("_Group2","anchorOffsetY",0),
					new eui.SetProperty("_Group2","horizontalCenter",0),
					new eui.SetProperty("_Group2","top",268),
					new eui.SetProperty("_Group2","height",664)
				])
			,
			new eui.State ("help",
				[
					...
					new eui.SetProperty("_Group2","verticalCenter",28),
					new eui.SetProperty("_Group2","anchorOffsetY",0),
					new eui.SetProperty("_Group2","horizontalCenter",0),
					new eui.SetProperty("_Group2","top",268),
					new eui.SetProperty("_Group2","height",656)
				])
		];
	}
