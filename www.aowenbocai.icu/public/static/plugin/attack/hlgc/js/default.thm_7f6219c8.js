...
generateEUI.paths['resource/eui_skins/ButtonSkin.exml'] = window.skins.ButtonSkin = (function (_super) {
	...
	function GameUiSkin() {
		_super.call(this);
		this.skinParts = ["pay","cityImg","recharge","active","award","set","head","btns","back","bottom","Panel","history","fight","soldiers","reading","help","auto_fight","payBack2","payPanel","payBack","payGroup"];
		
		this.height = 1136;
		this.width = 640;
		this.pay_i();
		this.elementsContent = [this._Image1_i(),this._Group1_i(),this.head_i(),this.bottom_i(),this.history_i(),this.fight_i(),this.soldiers_i(),this.reading_i(),this.help_i(),this.auto_fight_i(),this.payGroup_i()];
	...
	_proto.bottom_i = function () {
		...
		t.horizontalCenter = 0;
		t.width = 640;
		t.elementsContent = [this._Rect3_i(),this._Rect4_i(),this._Label1_i(),this.btns_i(),this.back_i()];
		return t;
	};
	_proto._Rect3_i = function () {
		var t = new eui.Rect();
	...
	_proto.history_i = function () {
		...
		t.top = 120;
		t.width = 200;
		t.elementsContent = [this._Rect5_i(),this._Group4_i(),this.Panel_i()];
		return t;
	};
	...
	_proto._Group4_i = function () {
		...
		t.top = 5;
		t.percentWidth = 95;
		t.elementsContent = [this._Rect6_i(),this._Label3_i(),this._Image6_i()];
		return t;
	};
	...
	_proto.help_i = function () {
		...
		t.horizontalCenter = 0;
		t.percentWidth = 80;
		t.elementsContent = [this._Rect7_i(),this._Rect8_i(),this._Label4_i()];
		return t;
	};
	...
	var AlertSkin$Skin6 = 	(function (_super) {
		__extends(AlertSkin$Skin6, _super);
		function AlertSkin$Skin6() {
			_super.call(this);
			this.skinParts = ["labelDisplay"];
		...
		var _proto = AlertSkin$Skin6.prototype;
	...
	var AutoGameSkin$Skin7 = 	(function (_super) {
		__extends(AutoGameSkin$Skin7, _super);
		function AutoGameSkin$Skin7() {
			_super.call(this);
			this.skinParts = ["labelDisplay"];
		...
		var _proto = AutoGameSkin$Skin7.prototype;
		...
		return AutoGameSkin$Skin7;
	})(eui.Skin);

	function AutoGameSkin() {
		_super.call(this);
		this.skinParts = ["back1","sc","back","input0","question0","input1","question1","input2","question2","auto_selected","question3","auto_go"];
	...
	_proto._Group6_i = function () {
		...
		t.right = 0;
		t.top = 0;
		t.elementsContent = [this.back1_i(),this.sc_i(),this._Image1_i(),this._Label1_i(),this.back_i(),this._Group5_i()];
		return t;
	};
	...
	_proto._Group5_i = function () {
		...
		t.width = 580;
		t.layout = this._VerticalLayout1_i();
		t.elementsContent = [this._Group1_i(),this._Group2_i(),this._Group3_i(),this._Group4_i(),this.auto_go_i()];
		return t;
	};
	_proto._VerticalLayout1_i = function () {
		var t = new eui.VerticalLayout();
	...
	_proto._Group1_i = function () {
		...
		t.y = 295;
		t.layout = this._HorizontalLayout1_i();
		t.elementsContent = [this._Label2_i(),this.input0_i(),this.question0_i()];
		return t;
	};
	_proto._HorizontalLayout1_i = function () {
		var t = new eui.HorizontalLayout();
	...
	_proto._Group2_i = function () {
		...
		t.y = 305;
		t.layout = this._HorizontalLayout2_i();
		t.elementsContent = [this._Label3_i(),this.input1_i(),this.question1_i()];
		return t;
	};
	_proto._HorizontalLayout2_i = function () {
		var t = new eui.HorizontalLayout();
	...
	_proto._Group3_i = function () {
		...
		t.y = 315;
		t.layout = this._HorizontalLayout3_i();
		t.elementsContent = [this._Label4_i(),this.input2_i(),this.question2_i()];
		return t;
	};
	_proto._HorizontalLayout3_i = function () {
		var t = new eui.HorizontalLayout();
	...
	_proto._Group4_i = function () {
		...
		t.elementsContent = [this._Label5_i(),this.auto_selected_i(),this.question3_i()];
		return t;
	};
	...
	var AutoPanelSkin$Skin8 = 	(function (_super) {
		__extends(AutoPanelSkin$Skin8, _super);
		function AutoPanelSkin$Skin8() {
			_super.call(this);
			this.skinParts = ["labelDisplay"];
		...
		var _proto = AutoPanelSkin$Skin8.prototype;
	...
	_proto.cancel_i = function () {
		...
		t.top = 120;
		t.width = 80;
		t.skinName = AutoPanelSkin$Skin8;
		return t;
	};
	...
	_proto._Group1_i = function () {
		...
		t.horizontalCenter = 0;
		t.verticalCenter = 0;
		t.elementsContent = [this._Rect1_i(),this.giftImg_i(),this._Image1_i(),this._Label1_i(),this.gift_i()];
		return t;
	};
	_proto._Rect1_i = function () {
		var t = new eui.Rect();
		...
		t.ellipseHeight = 0;
		t.ellipseWidth = 0;
		t.fillColor = 0xe0aa35;
		t.height = 100;
		t.horizontalCenter = 0;
		t.strokeColor = 0xd62c2c;
		t.percentWidth = 100;
		return t;
	};
