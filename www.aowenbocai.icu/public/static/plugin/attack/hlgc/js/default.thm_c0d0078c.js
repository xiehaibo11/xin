...
generateEUI.paths['resource/eui_skins/ButtonSkin.exml'] = window.skins.ButtonSkin = (function (_super) {
	...
	return CheckBoxSkin;
})(eui.Skin);generateEUI.paths['resource/eui_skins/ui/InputAddSkin.exml'] = window.InputAddSkin = (function (_super) {
	...
	function GameUiSkin() {
		_super.call(this);
		this.skinParts = ["pay","cityImg","recharge","active","award","set","head","codeInpt","cut","add","back","bottom","Panel","history","fight","soldiers","reading","help","auto_fight","createRoom","JionRoom","payBack2","payPanel","payBack","payGroup","alertSure","alertCancel","alert"];
	...
	_proto.bottom_i = function () {
		...
		t.horizontalCenter = 0;
		t.width = 640;
		t.elementsContent = [this._Rect3_i(),this._Rect4_i(),this._Label1_i(),this._Group4_i(),this.back_i()];
		return t;
	};
	_proto._Rect3_i = function () {
		var t = new eui.Rect();
	...
	_proto._Group4_i = function () {
		...
		t.width = 316;
		t.elementsContent = [this.codeInpt_i(),this.cut_i(),this.add_i()];
		return t;
	};
	...
	var AlertSkin$Skin7 = 	(function (_super) {
		__extends(AlertSkin$Skin7, _super);
		function AlertSkin$Skin7() {
			_super.call(this);
			this.skinParts = ["labelDisplay"];
		...
		var _proto = AlertSkin$Skin7.prototype;
	...
	var AutoGameSkin$Skin8 = 	(function (_super) {
		__extends(AutoGameSkin$Skin8, _super);
		function AutoGameSkin$Skin8() {
			_super.call(this);
			this.skinParts = ["labelDisplay"];
		...
		var _proto = AutoGameSkin$Skin8.prototype;
	...
	var AutoPanelSkin$Skin12 = 	(function (_super) {
		__extends(AutoPanelSkin$Skin12, _super);
		function AutoPanelSkin$Skin12() {
			_super.call(this);
			this.skinParts = ["labelDisplay"];
		...
		var _proto = AutoPanelSkin$Skin12.prototype;
	...
	_proto.cancel_i = function () {
		...
		t.top = 120;
		t.width = 80;
		t.skinName = AutoPanelSkin$Skin12;
		return t;
	};
