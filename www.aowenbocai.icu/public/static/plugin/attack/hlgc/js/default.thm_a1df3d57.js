...
generateEUI.paths['resource/eui_skins/ButtonSkin.exml'] = window.skins.ButtonSkin = (function (_super) {
	...
	_proto.help_i = function () {
		...
		t.horizontalCenter = 0;
		t.percentWidth = 80;
		t.elementsContent = [this._Rect7_i(),this._Rect8_i(),this._Label4_i(),this._Image10_i(),this._Image11_i()];
		return t;
	};
	...
	_proto.alert_i = function () {
		...
		t.verticalCenter = 0;
		t.width = 400;
		t.elementsContent = [this._Image12_i(),this._Label5_i(),this._Label6_i(),this.alertSure_i(),this.alertCancel_i()];
		return t;
	};
