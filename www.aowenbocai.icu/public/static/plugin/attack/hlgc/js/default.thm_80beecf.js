...
generateEUI.paths['resource/eui_skins/ButtonSkin.exml'] = window.skins.ButtonSkin = (function (_super) {
	...
	function GameUiSkin() {
		_super.call(this);
		this.skinParts = ["cityImg","recharge","active","award","set","head","cut","add","codeInpt","back","all_in","bottom","Panel","history","fight","soldiers","reading","help","auto_fight","createRoom","JionRoom","alertSure","alertCancel","alert"];
		
		this.height = 1136;
		this.width = 640;
		this.elementsContent = [this._Image1_i(),this._Group1_i(),this.head_i(),this.bottom_i(),this.history_i(),this.fight_i(),this.soldiers_i(),this.reading_i(),this.help_i(),this._Group6_i(),this._Group7_i()];
	}
