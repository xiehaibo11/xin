...
generateEUI.paths['resource/eui_skins/ButtonSkin.exml'] = window.skins.ButtonSkin = (function (_super) {
	...
	function GameUiSkin() {
		_super.call(this);
		this.skinParts = ["bg_img","turntable","his_panel","balance","times","help","back_btn","music_btn"];
	...
	_proto._Group1_i = function () {
		var t = new eui.Group();
		t.elementsContent = [this._Image1_i(),this._Image2_i(),this._Image3_i(),this.turntable_i(),this.his_panel_i(),this.balance_i(),this.times_i(),this.help_i(),this.back_btn_i(),this.music_btn_i()];
		return t;
	};
	_proto._Image1_i = function () {
		var t = new eui.Image();
