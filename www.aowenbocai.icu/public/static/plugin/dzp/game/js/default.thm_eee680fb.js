...
generateEUI.paths['resource/GameSkins/AlertSkin.exml'] = window.AlertSkin = (function (_super) {
	...
	function GameUiSkin() {
		_super.call(this);
		this.skinParts = ["light","bg_img","light1","light0","turntable","his_panel","balance","times","help","back_btn","music_btn"];
		...
		eui.Binding.$bindProperties(this, ["light0"],[0],this._TweenItem2,"target")
	...
	_proto._Group1_i = function () {
		var t = new eui.Group();
		t.elementsContent = [this._Image1_i(),this.light1_i(),this.light0_i(),this.turntable_i(),this.his_panel_i(),this.balance_i(),this.times_i(),this.help_i(),this.back_btn_i(),this.music_btn_i()];
		return t;
	};
	_proto._Image1_i = function () {
		var t = new eui.Image();
