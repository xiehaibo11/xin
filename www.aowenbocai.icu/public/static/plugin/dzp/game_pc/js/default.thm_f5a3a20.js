...
generateEUI.paths['resource/GameSkins/AlertSkin.exml'] = window.AlertSkin = (function (_super) {
	...
	function GameUiSkin() {
		_super.call(this);
		this.skinParts = ["light","light2","light1","turntable","back_btn","music_btn","times","his_panel","help"];
		...
		eui.Binding.$bindProperties(this, ["light2"],[0],this._TweenItem1,"target")
	...
	_proto._Group1_i = function () {
		...
		t.x = 56;
		t.y = 352;
		t.elementsContent = [this._Image2_i(),this.light2_i(),this.light1_i(),this.turntable_i(),this.back_btn_i(),this.music_btn_i()];
		return t;
	};
	...
	_proto._Group3_i = function () {
		...
		t.elementsContent = [this._Group2_i(),this.his_panel_i(),this.help_i()];
		return t;
	};
	...
	_proto._Group2_i = function () {
		...
		t.elementsContent = [this._Label1_i(),this.times_i(),this._Label2_i()];
		return t;
	};
	...
	_proto._Label4_i = function () {
		var t = new eui.Label();
		t.lineSpacing = 15;
		t.text = "1.每人每天有3次免费抽奖机会，点击“抽奖”按钮开始抽奖。";
		t.textColor = 0xCEBEBE;
		t.percentWidth = 100;
		t.x = 122;
		t.y = 57;
	...
	function ShowSkin() {
		_super.call(this);
		this.skinParts = ["img","txt","use_btn","main_group","dele_btn"];
		
		this.height = 800;
		this.width = 1280;
		this.elementsContent = [this._Rect1_i(),this.main_group_i(),this.dele_btn_i()];
	}
	...
	_proto.main_group_i = function () {
		...
		t.horizontalCenter = 0;
		t.verticalCenter = 0;
		t.elementsContent = [this._Image1_i(),this._Group1_i(),this.use_btn_i()];
		return t;
	};
	_proto._Image1_i = function () {
		var t = new eui.Image();
