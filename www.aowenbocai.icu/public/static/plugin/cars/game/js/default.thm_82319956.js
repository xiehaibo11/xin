...
generateEUI.paths['resource/eui_skins/ButtonSkin.exml'] = window.skins.ButtonSkin = (function (_super) {
	...
	function GameUiSkin() {
		_super.call(this);
		this.skinParts = ["showTw","road","car","road2","signs","operate","operateList","show","show1","cutDown","caopan","table","recent","betGroup","setUp","balance","head","payPanel","payBacks"];
	...
	_proto._Group8_i = function () {
		...
		t.top = 53;
		t.visible = false;
		t.elementsContent = [this.payPanel_i(),this.payBacks_i()];
		return t;
	};
