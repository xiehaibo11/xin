...
generateEUI.paths['resource/eui_skins/ButtonSkin.exml'] = window.skins.ButtonSkin = (function (_super) {
	...
	function GameUiSkin() {
		_super.call(this);
		this.skinParts = ["showTw","road","car","road2","signs","operate","operateList","show","show1","cutDown","caopan","table","recent","betGroup","setUp","balance","head"];
		
		this.height = 750;
		this.width = 1334;
		this.showTw_i();
		this.elementsContent = [this._Image1_i(),this.table_i(),this.recent_i(),this.betGroup_i(),this.head_i()];
